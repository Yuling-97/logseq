...
******* Ce problème est en réalité instationnaire, mais on constate que les résultats numérique avec le solver stationnaire ont un sens physique. Seulement les tourbillons sont moins nombreux qu'avec solver instationnaire, voir ci-dessous.
******* TODO On va faire les mêmes comparaisons pour un cas de Re=100.
:PROPERTIES:
:todo: 1610895950312
:END:
...
*****
$$Re=100$$ On observe un détachement tourbillonaire
****
***
