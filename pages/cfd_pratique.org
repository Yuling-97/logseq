...
On doit savoir que pour une fluide de viscosité =1, arrive avec une vitesse initiale =1 sur un cylindre de diamètre =1, le comportement en réalité est stationnaire et laminair, on ne peut pas utiliser le solver instationnaire pour résoudre numériquement!! D'où l'intérêt de consulter les essais expérimentaux avant de lancer un calcul numérique.
*****
$$Re=40$$ 
...
****** Remarques sur la [[convergence]]:
******* La Umax=1,5 indique que le calcul n'a pas convergé, donc on raffine jusqu'au 2eme maillage. Alors qu'on obtient Umax=1,6 donc on raffine jusqu'au 3eme maillage.
****
***
