...
On doit savoir que pour une fluide de viscosité =1, arrive avec une vitesse initiale =1 sur un cylindre de diamètre =1, le comportement en réalité est stationnaire et laminair, on ne peut pas utiliser le solver instationnaire pour résoudre numériquement!!
*****
$$Re=40$$ 
