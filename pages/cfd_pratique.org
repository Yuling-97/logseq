...
L'écoulement est instationnaire de 0 jusqu'à t=12, après lequel l'écoulement est stationnaire. Dans le cas instationnaire, on s'intéresse à l'oscillations ou l'écvolution.
****** Remarques sur la [[convergence]]:
