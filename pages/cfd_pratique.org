...
******* Certes, le 2eme et 3eme maillage ont un temps de calcul très important. Mais ils n'ont pas apporté des résultats très différents. Donc on peut conclure qu'un nombre d'élément = suffit pour un cas de calcul aussi simple.
